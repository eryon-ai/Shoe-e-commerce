...
- Name: forms.spec.ts >> Form Validations & Edge Cases >> checkout prevents advancement with missing shipping fields
- Location: tests/forms.spec.ts:5:7
