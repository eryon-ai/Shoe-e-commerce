...
Call log:
  ...
  - waiting for locator('nav a').filter({ hasText: 'VAULT' }).first()
    12 × locator resolved to <a href="/" class="font-display-xl text-title-md tracking-tighter text-on-surface hover:scale-105 transition-transform duration-300 cursor-pointer">VAULT</a>
